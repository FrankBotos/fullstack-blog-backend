...
const resolvers = {
  ...
  Mutation: {
    ...
    updateProfileImage: (parent, {
      userid,
      imgurl
    }, context, info) => {
      let newUser = _db__WEBPACK_IMPORTED_MODULE_0__["users"].find(user => user.id == userid);
